...
type FieldValidator = (fieldValue: any) => string
type Field = {
  optional: boolean
  options: {}
  labelCopy?: string
  ...
  component: (fieldComponent: any, fieldConfigOptions: any) => JSX.Element
}
type FormConfig = {
  formId: string
...
export type PublicFormProps = {
  name?: string
  formChangeHandler?: (...args: any[]) => any
