### First Carrot is open by default
...
const demoQuestions = [
  {
    ...
    content: (
      <div>
        <p>
          Culpa occaecat nulla tempor in veniam exercitation qui in voluptate
          ullamco adipisicing fugiat. Cupidatat do officia est Lorem anim sunt
          enim aliqua deserunt ut aliqua excepteur. Et aliqua elit in dolor
          reprehenderit cillum ipsum irure aliquip duis labore ipsum.
        </p>
        <p>
          Excepteur et laborum ea enim dolor sit Lorem et cupidatat veniam
          pariatur consequat. Occaecat amet aliqua sunt exercitation ut quis
          consectetur anim aliquip ex non laboris. Id proident labore et ex
          laborum.
        </p>
      </div>
    ),
