...
TypeBase.COLORS = {
  ...
  // EPLI
  BRAND_MOSS_OPAQUE: COLORS.BRAND_MOSS_OPAQUE,
  BRAND_DUCKEGG_TRANS: COLORS.BRAND_DUCKEGG_TRANS,
  BRAND_DUCKEGG_DARK: COLORS.BRAND_DUCKEGG_DARK,
  GOLD_TRANS: COLORS.GOLD_TRANS,
}
